...
This document is the full reference for the interpreter.
If you are new to the project, start with the main README for onboarding and everyday workflows, then use this file as the detailed manual.
...
This section summarizes the most important recent functionality and behavior changes.
...
These commands are useful when you want to see each top-level form exactly as the interpreter receives and evaluates it.
