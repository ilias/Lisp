...
(define (xor x y)      (CALLVBASIC 'XorObj x y))
...
(define (- . lst)       (if (null? (cdr lst)) (CALLVBASIC 'NegObj (car lst)) (reduce (lambda (a b)(CALLVBASIC 'SubObj a b)) 0 lst)))
...
(define (int? n)        (try (and (= (call n 'GetType) (get-type "System.Int32"))
                                  #t)
                             (try (and (= (call n 'GetType) (get-type "System.Double"))
...
(define (real? n)       (or (eqv? (call n 'GetType) (get-type "System.Single"))
